...
import com.photogame.imarena.Joystick.JoystickMovedListener;
import com.photogame.imarena.Joystick.JoystickView;
...
//                            mEngine.start();
        ...
        adView.setAdUnitId("ca-app-pub-9933822661785384/4017854157");
    ...
    public class LoadGameScne extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            playerOneTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(game.playerTexture1, game, "sprite_klonk_2blue.png", 0, 0, 11, 1);
            playerTwoTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(game.playerTexture2, game, "sprite_klonk_2orange.png", 0, 0, 11, 1);
